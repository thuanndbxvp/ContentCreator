...
const InitialState: React.FC = () => (
    <div className="text-text-secondary prose prose-invert max-w-none">
        <h2 className="text-xl font-semibold text-accent mb-4">Chào mừng bạn đến với Trợ lý Sáng tạo Kịch bản YouTube!</h2>
        <p>Công cụ này được thiết kế để giúp bạn biến những ý tưởng sơ khai thành các kịch bản video hoàn chỉnh, hấp dẫn và nhất quán. Dù bạn là một YouTuber dày dặn kinh nghiệm hay chỉ mới bắt đầu, Trợ lý AI sẽ là người đồng hành đắc lực của bạn.</p>
        <h3 className="text-lg font-semibold mt-6 mb-3 text-accent/90">Hướng dẫn sử dụng</h3>
        <ol className="list-decimal list-inside space-y-3">
            <li><strong>Cài đặt API Key:</strong> Lần đầu sử dụng, hãy nhấp vào biểu tượng <strong>Cài đặt (bánh răng)</strong> ở góc trên bên phải để thêm API Key Gemini của bạn.</li>
            <li><strong>Nhập Chủ đề Video:</strong> Bắt đầu bằng cách nhập ý tưởng chính của bạn vào ô "Chủ đề Video". Nếu bạn đang bí ý tưởng, hãy thử tính năng <strong>"Gợi ý từ AI"</strong>.</li>
            <li><strong>Tinh chỉnh & Tạo:</strong> Lựa chọn ngôn ngữ, phong cách, cấu trúc và nhấn <strong>"Tạo kịch bản"</strong>.</li>
            <li><strong>Tạo Hình ảnh/Video:</strong> Sau khi có kịch bản, mỗi phân cảnh sẽ có nút <strong>"Tạo Prompt Ảnh/Video"</strong> để bạn lấy ý tưởng cho các công cụ AI tạo hình ảnh.</li>
    ...
    <div className="bg-secondary rounded-lg shadow-xl h-full flex flex-col">
        ...
        {showActionControls && !isOutline && (
            <div className="p-4 border-t border-primary bg-primary/30">
                <h3 className="text-md font-semibold text-text-primary mb-2">Sửa đổi Kịch bản</h3>
                <textarea
                    rows={3}
                ...
                <button
                    ...
                    className="w-full mt-2 flex items-center justify-center bg-secondary hover:bg-primary disabled:bg-primary/50 disabled:cursor-not-allowed text-text-primary font-bold py-2 px-4 rounded-lg transition"
                >
