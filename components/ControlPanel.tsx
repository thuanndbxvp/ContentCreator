...
import type { StyleOptions, FormattingOptions, Tone, Style, Voice } from '../types';
...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  const handleAddKeyword = (keyword: string) => {
    // FIX: Changed to use the keywords prop directly instead of a functional update, to match the prop type.
  ...
  return (
    <div className="bg-secondary rounded-lg p-6 shadow-xl space-y-6">
      <div>
        <label htmlFor="topic" className="block text-sm font-medium text-text-secondary mb-2">1. Chủ đề Video</label>
        <textarea
          id="topic"
          rows={3}
      ...
      <div>
        <label htmlFor="language" className="block text-sm font-medium text-text-secondary mb-2">3. Ngôn ngữ</label>
        <select
          id="language"
      ...
      <div>
        <label className="block text-sm font-medium text-text-secondary mb-2">7. Cấu trúc & Định dạng</label>
